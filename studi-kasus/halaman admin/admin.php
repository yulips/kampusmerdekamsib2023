            ...
            <div class="card shadow mb-4">
              <div class="card-body">
                <div class="table-responsive">
                  <div id="btn1" class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button style="padding:0.5rem 1.1rem;" class="btn btn-primary me-md-2" type="button">
                        ...
                        <?php if(mysqli_num_rows($query) > 0) {?>
                          ...
                          ?>
                            ...
                            <td><?php echo $data["isbn"]?></td>
                                ...
                                <td>
                                  <img src="<?php echo "img buku/".$data['gambar'] ?>" alt="" width="70px">
                                </td>
